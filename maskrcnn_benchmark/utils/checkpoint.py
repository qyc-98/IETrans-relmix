...
class Checkpointer(object):
    ...
    def _load_model(self, checkpoint, load_mapping):
        a = checkpoint.pop("model")
        a.pop("module.roi_heads.box.predictor.cls_score.weight")
        a.pop("module.roi_heads.box.predictor.cls_score.bias")
        a.pop("module.roi_heads.box.predictor.bbox_pred.weight")
        a.pop("module.roi_heads.box.predictor.bbox_pred.bias")
        load_state_dict(self.model, a, load_mapping)

...
_C.MODEL = CN()
_C.MODEL.HUBNESS_SCALE = 1.0
_C.MODEL.CUMIX = True
_C.MODEL.AUG_PERCENT = 30
_C.MODEL.RANDOM_LAMBDA = True
_C.MODEL.MIXUP = True
...
_C.MODEL.ROI_RELATION_HEAD.NUM_CLASSES = 1807
...
_C.PATHS_DATA = os.path.join(os.path.dirname(__file__), "../datasets")
